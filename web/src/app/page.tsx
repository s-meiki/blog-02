      ...
      <Container className="space-y-12">
        <section className="space-y-6">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-3xl font-display font-bold text-neutral-900">最新記事</h2>
            <p className="text-neutral-600">Sanity Studio から更新された最新の記事をチェックしましょう。</p>
          </div>
          <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
            ...
            {(!latestPosts || latestPosts.length === 0) && (
              <p className="col-span-full rounded-2xl border border-dashed border-neutral-200 p-8 text-center text-neutral-500">
        ...
        <section className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
          <div className="space-y-6">
            <h2 className="text-2xl font-display font-semibold text-neutral-900">編集部のおすすめ</h2>
