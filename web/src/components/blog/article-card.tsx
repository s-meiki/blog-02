  ...
  return (
    <Link
      ...
      className={cn(
        ...
        variant === "compact" && "focus-visible:ring-offset-0",
      )}
    ...
    >
      <article
        className={cn(
          ...
          variant === "compact" && "flex-row items-center gap-4 border-none bg-transparent shadow-none group-hover:translate-y-0",
        )}
      >
        {post.coverImage?.url && (
          <div
            className={cn(
              ...
              variant === "compact" && "h-24 w-32 flex-shrink-0 rounded-xl",
            )}
          >
            <Image
              ...
              className={cn(
                ...
                variant === "compact" ? "rounded-xl" : "rounded-t-3xl",
              )}
        ...
        <div className={cn("flex flex-1 flex-col gap-4 p-7", variant === "compact" && "gap-3 p-0")}>
          ...
          <div className="space-y-3">
            <h3 className="text-2xl font-display font-semibold text-primary-900 transition-colors duration-300 group-hover:text-primary-600">
              {post.title}
            </h3>
